...
async def create_medexam(medexam: MedExamCreateSchema, db: AsyncSession = Depends(get_session)):
...
async def get_medexams_of_recruits(recruit_id: int, db: AsyncSession = Depends(get_session)):
